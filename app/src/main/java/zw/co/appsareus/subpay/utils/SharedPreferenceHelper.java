...
/**
 * Created by Lenos on 10/20/2018.
 */
...
public class SharedPreferenceHelper {
    ...
    /**
     * Helper Method for Setting up the Launcher Slider
     * @param isFirstTime
     */
    public void setFirstTimeLaunch(boolean isFirstTime) {
        setBooleanPreference("IsFirstTimeLaunch", isFirstTime);
    }

    /**
     * Helper Method for checking if its the first time the Application is run
     * @return
     */
    public boolean isFirstTimeLaunch() {
        return getBooleanPreference("IsFirstTimeLaunch",true);
    }
}
